pipeline {
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                git(url: 'https://github.com/Milahn-Henri-Louis-Irwin-ITBSA/alert-service', branch: 'main')
            }
        }
